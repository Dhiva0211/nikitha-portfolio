...
const TermsAndConditionsAcceptance1: FC<TermsAndConditionsAcceptanceProps> = ({
  formId,
  tCsAcc,
  onChange,
}) => {
  ...
  return (
    <>
      <button type="button" className="appearance-none">
        ...
        >
          <section
            className="m-2 flex h-12 w-20 items-center justify-center rounded-lg border-4 md:size-20"
            tabIndex={0}
          >
...
export default TermsAndConditionsAcceptance1;
