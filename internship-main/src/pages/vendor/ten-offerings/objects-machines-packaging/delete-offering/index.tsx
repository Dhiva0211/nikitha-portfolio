  ...
  return (
    <section className="m-4 sm:m-6 lg:m-8 xl:m-10">
      ...
      <h6 className="mb-6 text-center text-xl font-bold md:text-2xl lg:text-3xl">
        Are you certain you want to delete this offering?
      </h6>

      <p className="mb-6 text-center text-lg md:text-xl lg:text-2xl">
        By deleting this offering, you will delete all of the features,
        technology, size table and price information associated with this
        offering.
      </p>
      ...
      <section className="flex justify-center text-xl font-bold">
        <CommonLink
          href={routes.vendor.tenOfferings.objMachPack.deleteOfferingSuccess}
        >
