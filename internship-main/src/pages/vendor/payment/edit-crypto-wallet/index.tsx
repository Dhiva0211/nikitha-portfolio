...
const EditCryptoWallet: FC = () => (
  <section className="mt-4 w-full max-w-7xl px-4">
    <ShowWindowTitle smallTitle secondTitle="Payment" />

    <Select
      labelToUse="Chosen vendor crypto payment method"
      options={[' ', ' ', ' ']}
    />

    <h3 className="mt-8 text-center text-2xl font-bold">Edit crypto payment</h3>
    <Select labelToUse="Wallet exchange" options={[' ', ' ', ' ']} />
...
export default EditCryptoWallet;
