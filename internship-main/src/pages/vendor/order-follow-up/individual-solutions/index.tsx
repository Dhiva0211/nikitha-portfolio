...
const IndividualSolutions: FC = () => {
  ...
  return (
    <section className="mx-4 my-8 w-full max-w-7xl rounded-lg border-t-4 border-deep-sapphire bg-white p-4 shadow-md md:p-8">
      ...
      <section className="m-2 h-96 overflow-y-auto overflow-x-visible p-2">
      ...
      <TitleDescHr
        title="Automate Order Follow Up"
