...
const options = [
  ...
  },
  {
    ...
    link: routes.vendor.orderSetup.licenseNft.artwork.shippingDestination,
    query: null,
  },
  {
...
const OrderSetUp: FC = () => (
  <section className="mt-4">
    ...
    <section className="m-2 overflow-y-hidden overflow-x-visible p-2">
      ...
      <Link href={routes.vendor.orderSetup.licenseNft.artwork.trackingNumber}>
    ...
    <Description>
      ...
      and to attach that smart contract to your Artwork.
    </Description>
