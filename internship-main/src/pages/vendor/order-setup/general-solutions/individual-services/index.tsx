...
const options = [
  ...
  {
    name: 'Optional: Input One Purchase Software Solution Git Link',
    link: routes.vendor.orderSetup.generalSolutions.individualServices
      .softwareSolution,
    query: null,
  },
...
const OrderSetUp: FC = () => {
  ...
  return (
    <section className="mt-4">
      ...
      <section className="m-2 h-auto max-h-96 overflow-y-auto overflow-x-visible p-2">
      ...
      <section className="m-2 space-y-4">
        {options.map(({ name, link, query }) => (
          <Link
            ...
            className="m-2 flex items-center justify-between rounded-lg border border-corn-flower-blue/60 bg-corn-flower-blue/40 p-4 text-sm sm:text-base md:text-lg lg:text-xl"
          >
            <span>{name}</span>
      ...
      <Description>
        ...
        &quot;Choose Solution Delivery Method&quot;, you can easily set up your
        delivery methods.
      </Description>
