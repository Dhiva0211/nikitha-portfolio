...
const listOptions1 = [
  {
    title: 'Go to sales account',
    link: routes.vendor.accounts.salesAccount.default,
  },
  {
    title: 'Go to inventory account',
...
const listOptions2 = [
  {
    title: 'Manually input your data to make more complete cash account',
    link: routes.vendor.accounts.cashAccount.manualInput,
  },
  {
...
const CashAccount: FC = () => (
  <section className="mt-4">
    ...
    <section className="m-4">
      <h3 className="text-3xl font-bold">Cash account</h3>
    ...
    <section className="m-2 rounded-3xl border-4 p-2">
      ...
      <section className="ml-64 mt-4 text-lg font-bold">
        ...
        <section className="mt-4">
          ...
          <section className="ml-4">Net Sales</section>
        ...
        <section className="mt-4">
          ...
          <section className="ml-4">Boosts</section>
          <section className="ml-4">Ad Attacks</section>
          <section className="ml-4">Crypto Devaluation</section>
          <section className="ml-4">Payment to Vendor</section>
          <section className="ml-4">Other</section>
        </section>
    ...
    <Description>
      UpUnikSelf only provides data to fill the Accounting items related to
      transactions fulfilled through UpUnikSelf. You can choose to add data to
      complete the Cash Account by clicking on the button below or integrate
      with your accounting software. UpUnikSelf will add the inputted data and
      provide you with a more complete Cash Account. You should consult with an
