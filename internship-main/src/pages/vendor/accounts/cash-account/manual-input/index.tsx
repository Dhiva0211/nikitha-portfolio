...
const ManualInput: FC = () => (
  <section className="mt-4">
    ...
    <section className="m-2 overflow-x-scroll rounded-3xl border-4 p-2">
      ...
      <section className="ml-72 mt-4 text-lg font-bold">
        <section className="mt-4">
    ...
    <Description>
      It may be of interest to you to build a basic Cash Account which will give
      you, a business entrepreneur, insights on its performance over a certain
      period.
      <br />
    ...
    <CommonLink href={routes.vendor.accounts.cashAccount.default}>
