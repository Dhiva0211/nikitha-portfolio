  ...
  <section className="mt-4">
    ...
    <section className="m-2 overflow-x-scroll rounded-3xl border-4 p-2">
      <section className="flex w-screen justify-around">
        ...
        <h4 className="ml-48 text-xl font-bold">UpUnikSelf transactions</h4>
    ...
    <Description>
      It may be of interest to you to build a basic Cash Flow Statement which
      will give you, a business entrepreneur, insights on its performance over a
      certain period.
      <br />
    ...
    <CommonLink href={routes.vendor.accounts.cashFlow.default}>
