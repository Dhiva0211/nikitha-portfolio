  ...
  <section className="mt-4 w-full max-w-7xl px-4">
    ...
    <Description as="section">
      ...
      <section className="space-y-2 p-2 text-center">
        ...
        <p>
          <b>Step 1: </b>
          Ensure that UpUnikSelf provides an API that allows you to
          programmatically interact with their platform. Click here to check.
        </p>
        <p>
          <b>Step 2: </b>
          Install on your service software an API that allows for the
          generation of user accounts and providing access to features.
        </p>
        <p>
          <b>Step 3: </b>
    ...
    <CommonLink
      href={
        routes.vendor.logisticsAndApis.generalSolutions.subscription.continue
      }
    >
