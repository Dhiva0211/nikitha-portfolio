...
const NonMintedNft: FC = () => (
  <section className="mt-4">
    <ShowWindowTitle smallTitle secondTitle="Logistics" />

    <Description>
      You need to decide to allow or not the license agreement to be embedded to
      your NFT. The Shoppitto will be informed of your decision before purchase.
      <br />
    ...
    <CommonLink
      href={routes.vendor.logisticsAndApis.licenseNft.nonMintedNft.continue}
    >
