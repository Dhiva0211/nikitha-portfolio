        ...
        {steps.map((step, index) => (
          ...
          >
            <input
              ...
              className="w-full border-b-2 border-gray-300 p-2 text-lg placeholder:text-corn-flower-blue focus:border-deep-sapphire focus:outline-none"
              maxLength={155}
            />
            <textarea
              ...
              className="mt-4 w-full border-b-2 border-gray-300 p-2 text-lg placeholder:text-corn-flower-blue focus:border-deep-sapphire focus:outline-none"
              maxLength={155}
            />
