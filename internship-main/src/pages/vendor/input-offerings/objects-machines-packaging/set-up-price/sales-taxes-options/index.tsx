...
const OjbMachinesPackagingSalesTaxesOptions: FC = () => (
  <SalesTaxesOptions
    returnTo={routes.vendor.inputOfferings.objMachPack.setUpPrice.default}
  />
);

export default OjbMachinesPackagingSalesTaxesOptions;
